  ...
  return (
    <>
      <div className="w-full flex justify-center bg-gradient-to-r from-[#386957] to-[#134d38]">
        <div
          className="lg:w-[1440px] mb:w-[342px] md:w-[95vw] md:h-[720px] mb:h-[694px] bg-cover bg-center"
          style={{
            backgroundImage:
              "url(https://static.bandainamcoent.eu/high/dragon-ball/dragon-ball-sparking-zero/00-page-setup/Page-Setup-Revamp/DBSZ_banner_mobile.jpg)",
          }}
        >
          {/* about */}
          {/* <div className="flex flex-col *:flex *:flex-col md:pl-16 md:py-[120px] mb:py-[57px]">
            <div>
              ...
              CỬA HÀNG TỐT NHẤT ĐỂ MUA MÔ HÌNH ONLINE
              </strong>
            ...
            <div className="flex flex-col *:text-white lg:mt-[105px] mb:mt-[39px]">
              <div className="flex font-bold items-center lg:w-[356px] lg:justify-between lg:gap-x-0 mb:gap-x-[22px] *:lg:text-2xl *:mb:text-lg mb:tracking-[0.2px] lg:tracking-0">
              <span>Giảm giá 25%</span>|<span>Miễn phí vận chuyển</span>
              </div>
              <a
